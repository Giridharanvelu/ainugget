...
const HomePageThree = () => {
    return (
        <Fragment>
            <HeroArea/>
            <FeaturedTwo className="lightVersionWrapper" lightVersion={true} featured={featured}/>
            <AboutUsSection/>
            <WhatWeOfferThree/>
            <ProfitGraphSection/>
            <BannerSection/>
            <HightchartMap/>
            <OurAchievementsTwo className="achivementThree" />
            <Testimonial className="testimonialThreeWrapper" version='two'/>
            <BlogSectionTwo noTags={true} />
            <WorkInquiry/>
            <Footer/>
        </Fragment>
    )
